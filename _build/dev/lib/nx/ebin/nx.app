{application,nx,
             [{modules,['Elixir.Inspect.Nx.Batch',
                        ...
                        'Elixir.Nx.Defn.Graph','Elixir.Nx.Defn.Graph.Stage',
                        'Elixir.Nx.Defn.Kernel','Elixir.Nx.Defn.TemplateDiff',
                        'Elixir.Nx.Defn.Token','Elixir.Nx.Defn.Tree',
                        'Elixir.Nx.Heatmap','Elixir.Nx.HiddenServing',
                        'Elixir.Nx.LazyContainer',
                        ...
                        'Elixir.Nx.LinAlg.BlockEigh',
                        'Elixir.Nx.LinAlg.Cholesky','Elixir.Nx.LinAlg.Eigh',
                        'Elixir.Nx.LinAlg.LU','Elixir.Nx.LinAlg.QR',
                        'Elixir.Nx.LinAlg.SVD','Elixir.Nx.Pointer',
                        'Elixir.Nx.Random','Elixir.Nx.Serving',
                        'Elixir.Nx.Serving.Default','Elixir.Nx.Shape',
                        'Elixir.Nx.Shared','Elixir.Nx.TemplateBackend',
                        'Elixir.Nx.Tensor','Elixir.Nx.Testing',
                        'Elixir.Nx.Type']},
